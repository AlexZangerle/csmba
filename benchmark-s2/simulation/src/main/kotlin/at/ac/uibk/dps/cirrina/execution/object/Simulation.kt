...
fun main(args: Array<String>) {
    ...
    println("  Scenario 2 — Comfort Convergence Simulation")
    ...
    val key = KeyExpr.tryFrom("events/peripheral/sensorOccupancyReceived").getOrThrow()

    fun publishSensor() {
        val event = Event(
            topic = "sensorOccupancyReceived",
            channel = EventChannel.PERIPHERAL,
            data = ArrayList<ContextVariable>().apply { add(cv("imageData", "bench")) },
            source = "peripheral",
